...
public class TenantAgentPropertyContract implements Contract {
    public static final String ID = "com.riequation.property.contracts.TenantAgentPropertyContract";
    ...
    private void verifyCreate(LedgerTransaction tx) {
        ...
        TenantAgentPropertyContractState outputState = (TenantAgentPropertyContractState) tx.getOutputStates().get(0);
    ...
    private void verifyAmend(LedgerTransaction tx) {
        ...
        TenantAgentPropertyContractState inputState = (TenantAgentPropertyContractState) tx.getInputStates().get(0);
        TenantAgentPropertyContractState outputState = (TenantAgentPropertyContractState) tx.getOutputStates().get(0);
