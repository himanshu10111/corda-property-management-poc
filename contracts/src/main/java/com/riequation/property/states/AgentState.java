...
@BelongsToContract(AgentContract.class)
public class AgentState implements LinearState {
    private final String name;
    private final String email;
    private final String password; // Should be a hashed password for security
    private final String mobileNumber;
    private final String address;
    private final AbstractParty host; // The node hosting this agent account
    private final UniqueIdentifier linearId; // Unique identifier for the state

    public AgentState(String name, String email, String password, String mobileNumber, String address, AbstractParty host, UniqueIdentifier linearId) {
        this.name = name;
        this.email = email;
